...
DATA = ROOT / "Data"
PAIRS = DATA / "Inputs" / "paired_observations.csv.gz"
CONFIG = ROOT / "Code" / "configs" / "scientific_execution.yaml"
RESULTS = DATA / "Results"
STAGE2 = DATA / "DPM_stage2"
...
def main() -> None:
    expected_hash = "cb439b63d5d346abdc8d2b8bf0e1a2204045c784e73ab8225e67c4fa47cbccfb"
    ...
    expected_multi = pd.read_csv(RESULTS / "04_master_tables" / "multi_aoi_run_results.csv")
    ...
    expected_rolling = pd.read_csv(RESULTS / "04_master_tables" / "rolling_origin_run_results.csv")
    expected_rolling = expected_rolling.merge(
        pd.read_csv(RESULTS / "03_rolling_origin_results" / "ROLLING_ORIGIN_COEFFICIENTS.csv")
        [["AOI", "sensor", "rolling_id", "slope", "intercept"]],
    ...
    expected_dpm = pd.read_csv(STAGE2 / "dpm_all_aoi_candidate_results.csv")
